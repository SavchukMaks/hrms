    ...
    <div class="vacancies-list-item">
        <div class="vacancies-item-header">
           ...
           <div class="vacancies-item-btn">
               <a href="#" class="add-customer-popup" onclick="showPopupCustomer(event, {{ $vacancy->id }}, $('#add-customer'))">Add customer</a>
       ...
       <div class="vacancies-item-details">
           ...
           <div class="item-details-block">
               <span class="details-block-number">{{ $vacancy->applied }}</span>
               <p>Applied</p>
           </div>
